...
Usage:
    ...
    python src/models/xgboost_hyperparameter_tuning.py --target profit_margin --trials 30
...
class XGBoostTuner:
    ...
    def train_best_model(
        ...
        self.best_model.set_params(early_stopping_rounds=30)
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Tune profit_margin (worst performer) with 30 trials
  python xgboost_hyperparameter_tuning.py --target profit_margin --trials 30
